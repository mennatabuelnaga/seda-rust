...
pub trait MainChainAdapterTrait {
    async fn sign_and_send_tx(&self, tx_params: TransactionParams, server_url: String) -> String;
    fn sign_tx(&self, tx_params: TransactionParams) -> Result<SignedTransaction>;
    fn view(&self, contract_id: String, method_name: String, args: Vec<u8>, server_addr: String) -> Result<String>;
...
//         .next()
//         .map_err(|_|
// NearAdapterError::MissingParam("contract_id".to_string()))?;     let node_id:
// Number = seq         .next()
//         .map_err(|_| NearAdapterError::MissingParam("node_id".to_string()))?;
//     let server_addr: String = seq
//         .next()
//         .map_err(|_|
// NearAdapterError::MissingParam("server_addr".to_string()))?;
...
//         .next()
//         .map_err(|_|
// NearAdapterError::MissingParam("contract_id".to_string()))?;     let limit:
// Number = seq         .next()
...
//         .next()
//         .map_err(|_|
// NearAdapterError::MissingParam("signed_tx".to_string()))?;
//     let server_addr: String = seq
//         .next()
//         .map_err(|_|
// NearAdapterError::MissingParam("server_addr".to_string()))?;
