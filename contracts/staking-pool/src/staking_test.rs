...
mod tests {
    ...
    fn test_stake_all_unstake_all() {
        ...
        emulator
            .contract
            .deposit_and_stake(deposit_amount.into(), bob().try_into().unwrap());
    ...
    fn test_two_delegates() {
        ...
        emulator.update_context(token(), ntoy(1_000_000));
        emulator
            .contract
            .deposit(ntoy(1_000_000).into(), alice().try_into().unwrap());
        ...
        emulator
            .contract
            .deposit(ntoy(1_000_000).into(), bob().try_into().unwrap());
        emulator.amount += ntoy(1_000_000);
        emulator.update_context(bob(), 0);
        emulator.contract.stake(ntoy(1_000_000).into());
        emulator.simulate_stake_call();
    ...
    fn test_low_balances() {
        ...
        emulator.update_context(token(), initial_balance);
        emulator
            .contract
            .deposit(initial_balance.into(), alice().try_into().unwrap());
