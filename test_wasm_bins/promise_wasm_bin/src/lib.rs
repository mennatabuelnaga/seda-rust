// TODO re-enable most this file
// only http fetch test is enabled to do a simple hello world test
// use std::env;

// use seda_runtime_sdk::wasm::{call_self, http_fetch};
...
//     //     .then(call_self("db_fetch_success",
//     // vec!["ArgFromInsideWasm".to_string()]));
// }
...
#[no_mangle]
pub extern "C" fn http_fetch_test() {
    dbg!("http_fetch_test");
    // let args: Vec<String> = env::args().collect();
    println!("Hello world {:?}", "args");
